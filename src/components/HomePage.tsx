...
function ServicesSection() {
  const { setPage } = useApp();
  const services = [
    { name: 'Moving Services',     desc: 'Full house and apartment moving with professional movers and vehicles.', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80', iconPath: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
    { name: 'Furniture Transport', desc: 'Safe transport for individual furniture pieces and sets.', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&q=80', iconPath: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
    { name: 'Office Relocation',   desc: 'Complete office moving with minimal business disruption.', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&q=80', iconPath: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { name: 'Same-Day Delivery',   desc: 'Urgent deliveries completed within the same day.', image: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&q=80', iconPath: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { name: 'Student Moving',      desc: 'Affordable moving packages designed for students.', image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=600&q=80', iconPath: 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
    { name: 'Cargo Delivery',      desc: 'Commercial cargo and goods transportation services.', image: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=600&q=80', iconPath: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  ];
